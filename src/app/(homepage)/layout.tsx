...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "OpenCultures",
    description:
      "Design principles for climate-sensitive urban development based on citizens’ everyday practices.",
    url: "https://www.opencultures.org",
    siteName: "OpenCultures",
    images: [
      {
        url: "https://opencultures.org/oc-image.png",
        width: 1200,
        height: 830,
        alt: "OpenCultures Preview Image",
      },
    ],
    locale: "en_US",
    type: "website",
